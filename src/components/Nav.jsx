...
const Nav = ({ logo, liste, links }) => {
  ...
  return (
    <>
      <nav className="bg-white border-gray-200 py-2.5 dark:bg-gray-900 z-50">
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
          <a href="#" className="flex items-center">
            <img src={logo} className="h-6 mr-3 sm:h-9" alt="React Logo" />
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white mr-20">React</span>
          </a>
...
Nav.propTypes = {
  ...
  liste: PropTypes.arrayOf(PropTypes.string).isRequired,
